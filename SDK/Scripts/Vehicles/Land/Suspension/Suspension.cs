...
namespace MetaverseCloudEngine.Unity.Vehicles
{
    ...
    [AddComponentMenu(MetaverseConstants.MenuItems.MenuRootPath + "Vehicles/Land/Suspension/Vehicles - Suspension", 0)]
        ...
        void Start() {
            ...
            if (Application.isPlaying) {
                ...
                if (generateHardCollider) {
                    ...
                    cap.layer = Physics.IgnoreRaycastLayer;
                    ...
                    compressCol.sharedMaterial = Wheel.FrictionlessMat;
                }
        ...
        void ApplySuspensionForce() {
            if (wheel.grounded && wheel.connected) {
                ...
                if (compression == 0 && !generateHardCollider && applyHardContactForce) {
                    rb.AddForceAtPosition(
                        -vp.norm.TransformDirection(0, 0, Mathf.Clamp(travelVel, -hardContactSensitivity * TimeValues.FixedTimeFactor, 0) + penetration) * hardContactForce * Mathf.Clamp01(TimeValues.FixedTimeFactor),
                        applyForceAtGroundContact ? wheel.contactPoint.point : wheel.tr.position,
                        vp.suspensionForceMode);
                }
            }
