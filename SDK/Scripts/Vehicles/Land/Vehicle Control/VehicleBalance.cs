...
namespace MetaverseCloudEngine.Unity.Vehicles
{
    ...
    [AddComponentMenu(MetaverseConstants.MenuItems.MenuRootPath + "Vehicles/Land/Vehicle Controllers/Vehicles - Vehicle Balance", 4)]
    ...
    public class VehicleBalance : MonoBehaviour
    {
        ...
        void ApplyLean() {
            ...
            targetLeanActual = Vector3.Lerp(targetLeanActual, vp.norm.TransformDirection(targetLean), (1 - leanSmoothness) * Time.timeScale * TimeValues.InverseFixedTimeFactor).normalized;
