...
namespace MetaverseCloudEngine.Unity.Vehicles
{
    ...
    [AddComponentMenu(MetaverseConstants.MenuItems.MenuRootPath + "Vehicles/Land/Drivetrain/Transmission/Vehicles - Gearbox Transmission", 0)]
    ...
    public class GearboxTransmission : Transmission
    {
        ...
        void FixedUpdate() {
            ...
            shiftTime = Mathf.Max(0, shiftTime - Time.timeScale * TimeValues.InverseFixedTimeFactor);
            
            if (targetDrive == null || gears is not { Length: > 0 }) {
                return;
            }
