...
namespace Cinemachine
{
    ...
    /// </summary>
    public class CinemachineInputProviderUsingActionProperties : MonoBehaviour, AxisState.IInputAxisProvider
    {
        /// <summary>
        ...
        public InputActionProperty XYAxis;

        /// <summary>Float action for Z movement</summary>
        [Tooltip("Float action for Z movement")]
        public InputActionProperty ZAxis;

        /// <summary>If true, the look input flag will be required in order to read the XYAxis.</summary>
        [Tooltip("If true, the look input flag will be required in order to read the XYAxis.")]
        public bool RequireLookInputFlag = true;
        ...
        {
            if (enabled && (!RequireLookInputFlag || PlayerInputAPI.LookInputEnabled))
            {
        ...
        protected InputAction ResolveForPlayer(int axis, InputActionProperty actionRef)
        {
            ...
            if (m_cachedActions[axis] == null)
            {
                ...
                if (AutoEnableInputs && actionRef.action != null)
            ...
            InputAction GetFirstMatch(in InputUser user, InputActionProperty aRef) => 
